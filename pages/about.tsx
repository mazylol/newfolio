  ...
  return (
    <>
      ...
      <div className="w-full">
        <p className="p-5 text-7xl text-white font-extrabold text-center ml-16">About Me</p>
        ...
        <p className="text-2xl text-gray-200 text-center ml-16 p-5">
          ...
          <span className="font-bold">{Age()}</span> years of age. I got into programming during the
          great quarantine of 2020. I was bored out of my mind and started to learn Python. At first
          it started with Discord bots, then it bloomed into other things. Such as Arch Installation
          Scripts, SFTP Clients, and Websites. Now I program nearly every day and have a fantastic
          time doing so.
        </p>
